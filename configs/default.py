...
default_config = dict(
    ...
    # path_to_weights="./output/scoop-jelly/scoop-policy",
    ...
    algo_params=dict(
        meta_batch=15, # number of tasks to average the gradient across
        num_iterations=2500, # number of data sampling / training iterates
